...
getContractFactory(name: 'SouthAfricaVoting', signerOrOptions?: ethers.Signer | FactoryOptions): Promise<Contracts.SouthAfricaVoting__factory>

  getContractAt(name: 'Counter', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.Counter>
getContractAt(name: 'SouthAfricaVoting', address: string | ethers.Addressable, signer?: ethers.Signer): Promise<Contracts.SouthAfricaVoting>

  deployContract(name: 'Counter', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.Counter>
deployContract(name: 'SouthAfricaVoting', signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.SouthAfricaVoting>

  deployContract(name: 'Counter', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.Counter>
deployContract(name: 'SouthAfricaVoting', args: any[], signerOrOptions?: ethers.Signer | DeployContractOptions): Promise<Contracts.SouthAfricaVoting>
